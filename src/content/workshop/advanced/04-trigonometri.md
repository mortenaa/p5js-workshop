...
description: Lær å bruke trigonometri (sinus og cosinus) til å tegne regulære mangekanter og stjerner i p5.js.
---


# Introduksjon

Nå som du kan tegne [mangekanter](/p5js-workshop/workshop/advanced/02-mangekanter), 
...
omrisset](/p5js-workshop/images/SirkelRadius.png "En sirkel med linjer med lengde `r` fra sentrum av
...
sentrum.](/p5js-workshop/images/RettvinkletTrekantSirkel.png "En rettvinklet trekant mellom et punkt i
...
sidene.](/p5js-workshop/images/TrekantSiderSirkel.png "Den samme rettvinklede trekanten med formler
...
[mangekanter](/p5js-workshop/workshop/advanced/02-mangekanter).

- [ ] Vi begynner med å tegne opp en regulær pentagon (femkant).

  ```javascript
  const KANTER = 5;
  let vinkel = 360.0 / KANTER;
  ...
  function draw() {
    ...
    beginShape();
    for (let hjorne = 0; hjorne < KANTER; hjorne++) {
  ...
  opp, og `radians` som regner grader om til radianer, en
...
72°.](/p5js-workshop/images/Femkant.png "Vinkelen mellom to nabohjørner og sentrum i en femkant er
360° / 5 = 72°.")
...
![Femkanten før og etter rotering.](/p5js-workshop/images/FemkantRotering.png "Femkanten før og etter
rotering.")
...
![Femkanten snurrer rundt.](/p5js-workshop/images/FemkantSnurrer.gif "Femkanten snurrer rundt.")
...
stjerne er 2 · 360° / 5 = 144°.](/p5js-workshop/images/Pentagram.png "Vinkelen mellom en spiss,
...
- [ ] I den nye løkken, endrer du `let hjorne = 0` til `let hjorne = 1`, slik at
...
- [ ] Pass på at `KANTER` settes til et partall som er minst `6`.
  ...
  ![Bilde av et oktagram](/p5js-workshop/images/Oktagram.png "Vinkelen mellom en spiss, sentrum og
...
- [ ] Kan du tegne opp flere mangekanter eller stjerner på skjermen samtidig?
  ...
  ![Bilde av flere stjerner samtidig.](/p5js-workshop/images/FlereStjerner.png "Flere stjerner
  samtidig.")

- [ ] Hvis stjernene dine ikke snurrer allerede, kan du få dem til å gjøre det?

  ![Bilde av tre stjerner som snurrer.](/p5js-workshop/images/FlereStjernerSnurrer.gif "Tre stjerner
  som snurrer.")
